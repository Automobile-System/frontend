          ...
          <div className="bg-[#020079]/5 h-80 rounded-lg flex flex-col items-center justify-center p-6">
            ...
            <div className="w-full h-56 flex items-end justify-center gap-8 px-4">
              <div className="flex flex-col items-center gap-2">
                <div className="w-16 bg-[#020079] rounded-t flex items-end justify-center pb-2" style={{ height: '190px' }}>
                  <span className="text-white text-xs font-semibold font-roboto">95%</span>
                </div>
                <span className="text-sm text-[#020079] font-roboto font-medium">Ruwan</span>
              </div>
              <div className="flex flex-col items-center gap-2">
                <div className="w-16 bg-[#03009B] rounded-t flex items-end justify-center pb-2" style={{ height: '184px' }}>
                  <span className="text-white text-xs font-semibold font-roboto">92%</span>
                </div>
                <span className="text-sm text-[#020079] font-roboto font-medium">Kamal</span>
              </div>
              <div className="flex flex-col items-center gap-2">
                <div className="w-16 bg-[#FFD700] rounded-t flex items-end justify-center pb-2" style={{ height: '194px' }}>
                  <span className="text-[#020079] text-xs font-semibold font-roboto">97%</span>
                </div>
                <span className="text-sm text-[#020079] font-roboto font-medium">Nimal</span>
              </div>
              <div className="flex flex-col items-center gap-2">
                <div className="w-16 bg-[#020079]/70 rounded-t flex items-end justify-center pb-2" style={{ height: '180px' }}>
                  <span className="text-white text-xs font-semibold font-roboto">90%</span>
                </div>
                <span className="text-sm text-[#020079] font-roboto font-medium">Amal</span>
              </div>
              <div className="flex flex-col items-center gap-2">
                <div className="w-16 bg-[#E6C200] rounded-t flex items-end justify-center pb-2" style={{ height: '176px' }}>
                  <span className="text-[#020079] text-xs font-semibold font-roboto">88%</span>
                </div>
                <span className="text-sm text-[#020079] font-roboto font-medium">Others</span>
              </div>
            </div>
          </div>
              ...
              <div className="space-y-4">
                <div>
                  <div className="flex justify-between text-sm mb-1 font-roboto">
                    <span className="text-[#020079] font-medium">Nimal Fernando</span>
                    <span className="text-[#020079]/60">45 requests</span>
                  </div>
                  <div className="bg-[#020079]/10 h-6 rounded-full overflow-hidden">
                    <div className="bg-[#020079] h-full rounded-full" style={{ width: '90%' }}></div>
                  </div>
                </div>
                <div>
                  <div className="flex justify-between text-sm mb-1 font-roboto">
                    <span className="text-[#020079] font-medium">Ruwan Silva</span>
                    <span className="text-[#020079]/60">38 requests</span>
                  </div>
                  <div className="bg-[#020079]/10 h-6 rounded-full overflow-hidden">
                    <div className="bg-[#FFD700] h-full rounded-full" style={{ width: '76%' }}></div>
                  </div>
                </div>
                <div>
                  <div className="flex justify-between text-sm mb-1 font-roboto">
                    <span className="text-[#020079] font-medium">Kamal Perera</span>
                    <span className="text-[#020079]/60">35 requests</span>
                  </div>
                  <div className="bg-[#020079]/10 h-6 rounded-full overflow-hidden">
                    <div className="bg-[#03009B] h-full rounded-full" style={{ width: '70%' }}></div>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="bg-white rounded-lg border-2 border-[#020079]/20 hover:border-[#020079]/40 transition-all shadow-sm p-6">
          ...
          <div className="bg-[#020079]/5 h-64 rounded-lg flex items-center justify-center mb-4">
            <div className="text-center">
              <p className="text-[#020079]/40 font-roboto mb-4">Line Chart Visualization</p>
              ...
              <div className="relative w-48 h-48 mx-auto">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <p className="text-xs text-[#020079]/60 font-roboto">Projects</p>
                  </div>
                </div>
              </div>
            </div>
