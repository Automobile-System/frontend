...
const LandingPage = () => {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-gray-600 mb-8 leading-relaxed font-inter text-lg">
                  ...
                  <strong className="text-red-600"> Our culture is built on three pillars: Promptness, Respect & Oneness.</strong>
                </p>
              </div>
            ...
            <div className="space-y-8">
              <div id="projects-preview">
                ...
                <h2 className="text-4xl md:text-5xl font-bold text-red-600 mb-4 font-roboto">PROJECTS</h2>
              ...
              <div className="space-y-4">
                {[
                  { name: "Fleet Maintenance Platform", desc: "Digital service scheduling and reporting for enterprise fleets.", bg: "bg-black" },
                  { name: "Express Detailing Kiosks", desc: "High‑throughput detailing with standardized quality.", bg: "bg-gray-800" },
                  { name: "EV Readiness Program", desc: "Diagnostics and training for hybrid/EV service bays.", bg: "bg-red-600" },
                  { name: "4x4 Custom Builds", desc: "Specialized off‑road kits and performance tuning.", bg: "bg-black" },
                  { name: "Service Management Suite", desc: "Unified intake to delivery with customer messaging.", bg: "bg-red-600" },
                  { name: "Supply Chain Portal", desc: "Parts tracking and vendor coordination for workshops.", bg: "bg-gray-800" }
                ].map((proj, index) => (
                  <div key={index} className="flex items-center space-x-4 p-4 bg-white rounded-lg shadow-md hover:shadow-lg transition-all duration-300 group">
                    <div className={`${proj.bg} text-white px-4 py-3 font-bold rounded font-roboto text-sm flex items-center group-hover:scale-105 transition-transform`}>
              ...
              <div className="flex flex-col sm:flex-row gap-4 mt-8">
                <Button asChild className="bg-red-600 hover:bg-red-700 text-white px-8 py-3 font-roboto font-medium transition-all duration-300 hover:scale-105 group">
                  <Link href="#about">
                    About us
  ...
  <section id="roadside" className="py-20 bg-gradient-to-br from-red-600 via-red-700 to-black text-white relative overflow-hidden">
        ...
        <div className="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-8">
              ...
              <div className="pt-6">
                <Button asChild size="lg" className="bg-white text-red-600 hover:bg-gray-100 font-roboto font-bold px-8 py-4 text-lg transition-all duration-300 hover:scale-105 group">
      ...
      <section id="projects" className="py-20 bg-white">
        <div className="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {[
              ...
              <Card key={idx} className="overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300">
                ...
                <CardContent className="p-4">
                  <h4 className="font-bold text-red-600 font-roboto">{p.title}</h4>
                </CardContent>
              </Card>
            ))}
          </div>
          ...
          <div className="text-center mt-10">
            <Button className="bg-red-600 hover:bg-red-700 text-white font-roboto font-medium px-8">View All Projects</Button>
          </div>
        </div>
      </section>
