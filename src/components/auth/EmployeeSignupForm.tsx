...
import { Eye, EyeOff, Mail, Lock, User, Phone, CreditCard, Briefcase, UserCog, ShieldCheck } from "lucide-react"
import { useState } from "react"
import Link from "next/link"

export default function EmployeeSignupForm() {
    const { formData, loading, fieldErrors, handleChange, handleSubmit } = useEmployeeSignupForm()
        ...
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-50 via-gray-100 to-slate-100 p-4 py-12">
            <div className="w-full max-w-2xl">
                ...
                <div className="text-center mb-8">
                    ...
                    <p className="text-gray-600">Employee Registration</p>
                </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-5">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="relative">
                                        ...
                                        <Input
                                            ...
                                            disabled={loading}
                                            className={`pl-11 h-12 bg-white border-gray-300 focus:border-red-600 focus:ring-red-600 text-gray-900 text-base placeholder:text-gray-400 ${
                                                fieldErrors.speciality ? "border-red-500 focus:border-red-500 focus:ring-red-500" : ""
                                            }`}
                                            required
                                        />
                                    </div>
                                    {fieldErrors.speciality && (
                                        <p className="text-sm text-red-600 flex items-center gap-1">
                                            <span className="font-medium">⚠</span> {fieldErrors.speciality}
                                        </p>
                                    )}
                                </div>
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="relative">
                                        <UserCog className="absolute left-3 top-1/2 transform -translate-y-1/2 h-5 w-5 text-gray-400 pointer-events-none z-10" />
                                        <select
                                            id="employeeType"
                                            name="employeeType"
                                            title="Employee Type"
                                            ...
                                            onChange={handleChange}
                                            disabled={loading}
                                            className={`pl-11 h-12 w-full bg-white border-2 border-gray-300 rounded-md focus:border-red-600 focus:ring-2 focus:ring-red-600 text-gray-900 text-base cursor-pointer ${
                                                fieldErrors.employeeType ? "border-red-500 focus:border-red-500 focus:ring-red-500" : ""
                                            }`}
                                            required
                                        >
                                    ...
                                    {fieldErrors.employeeType && (
                                        <p className="text-sm text-red-600 flex items-center gap-1">
                                            <span className="font-medium">⚠</span> {fieldErrors.employeeType}
                                        </p>
                                    )}
                                </div>
                            </div>
