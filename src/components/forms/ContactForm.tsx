            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  disabled={loading}
                  className={`pl-11 h-11 ${errors.name ? "border-red-500 focus:border-red-500 focus:ring-red-500" : "focus:border-red-600 focus:ring-red-600"}`}
                  required
                />
              </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  disabled={loading}
                  className={`pl-11 h-11 ${errors.email ? "border-red-500 focus:border-red-500 focus:ring-red-500" : "focus:border-red-600 focus:ring-red-600"}`}
                  required
                />
              </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  disabled={loading}
                  className="pl-11 h-11 focus:border-red-600 focus:ring-red-600"
                />
              </div>
            </div>

            <div className="space-y-2">
              <Label htmlFor="subject" className="text-sm font-semibold text-gray-700">Subject (optional)</Label>
              <Input
                id="subject"
                name="subject"
                ...
                disabled={loading}
                className="h-11 focus:border-red-600 focus:ring-red-600"
              />
            </div>
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <Textarea
                ...
                disabled={loading}
                className={`pl-11 min-h-32 ${errors.message ? "border-red-500 focus:border-red-500 focus:ring-red-500" : "focus:border-red-600 focus:ring-red-600"}`}
                required
              />
            </div>
