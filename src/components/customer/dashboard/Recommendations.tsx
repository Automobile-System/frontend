    ...
    <div style={{
      ...
      <div style={{
        ...
        <h2 style={{
          ...
          color: '#111827',
          margin: 0
        }}>Service Recommendations</h2>
        <span style={{
          fontSize: '0.875rem',
          color: '#6b7280'
        }}>{mockRecommendations.length} recommendations</span>
      </div>
        ...
        {mockRecommendations.map((rec) => (
          ...
          >
            <div style={{ display: 'flex', alignItems: 'flex-start', gap: '1rem' }}>
              ...
              <div style={{ flex: 1 }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginBottom: '0.25rem' }}>
                  ...
                  <span style={{
                    ...
                    borderRadius: '9999px',
                    backgroundColor: rec.priority === 'high' ? '#fecaca' : 
                                   rec.priority === 'medium' ? '#fef08a' : '#bfdbfe',
                    color: rec.priority === 'high' ? '#991b1b' : 
                          rec.priority === 'medium' ? '#854d0e' : '#1e40af'
                  }}>
              ...
              {/* Book Service Button → Navigates to /customer/book-service */}
              <button
